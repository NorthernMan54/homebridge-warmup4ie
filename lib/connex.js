/*
platform that offers a connection to a connex device.

this platform is inspired by the following code:
https://github.com/alex-0103/connex/blob/master/connex/connex.py
...
connex.prototype.setTargetTemperature = function(roomId, value, callback) {
...
connex.prototype.setRoomAuto = function(roomId, callback) {
...
connex.prototype.setRoomOverRide = function(roomId, callback) {
...
connex.prototype.setRoomFixed = function(roomId, callback) {
  // set device to manual mode
  // make sure the room/device is already configured
...
connex.prototype.setRoomOff = function(roomId, callback) {
  //  turn off device
  // make sure the room/device is already configured
  var body = {
    "account": {
